...
public class OAuth2User implements java.io.Serializable {
    ...
    public OAuth2User(String uid, String password) {
        this.uid = uid;
    ...
    private static final String PART_PATH_SYSTEM_ROLES = ",ou=System Roles,";
    ...
    private static String extractSystemRole(final String isMemberOf) {
        if ((isMemberOf != null) && !isMemberOf.isEmpty()) {
            if (isMemberOf.indexOf(PART_PATH_SYSTEM_ROLES) > 0) {
