...
<%
		Object object = session.getAttribute("logon");
		boolean isLogon = false;
		if(object!=null){
			Boolean ss = (Boolean)object;
			if(ss) {
				isLogon = true;
			}
		}
...
<head>
    ...
    <script src="SmsTreeData.js" type="text/javascript"></script>
     </script>
...
<div id="topmenu" class="l-topmenu">
    <div class="l-topmenu-logo">业务管理平台</div>
    <div class="l-topmenu-welcome">
       <!-- <a href="/dolphin/getVersion" class="l-link2" target="_blank">系统版本</a>
        <span class="space">|</span> -->
        <a href="/dolphin/logout.do" class="l-link2">登出</a>
    </div> 
</div>
  <div id="layout1" style="width:99.2%; margin:0 auto; margin-top:4px; "> 
        <div position="left"  title="主菜单" id="accordion1"> 
                    <div title="业务功能" class="l-scroll">
    ...
    <div  style="height:32px; line-height:32px; text-align:center;">
            Copyright © 2012 www.dolphin001.cn
    </div>
</body>
</html>
