...
public class JsonUtil {  
    ...
    public static String getJSONStringFromXML(String xml){
    	XMLSerializer readXML = new XMLSerializer();
    	return readXML.read(xml).toString();
    }

      
    private static void setCustomizeDataFormat(){
        //设定日期转换格式  
    ...
    public static void main(String[] arg) {  
        ...
        System.out.println(JsonUtil.getJSONString(a));
    }  
}  